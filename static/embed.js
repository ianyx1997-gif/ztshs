...
(function() {
  ...
  var I18N = {
    ro: {
      ...
      facFirstLine: '🏖️ Prima linie', facPool: '🏊 Piscină', facAqua: '💦 Aquapark', facBeach: '⛱️ Șezlonguri și umbrele gratis', facAdult: '🔞 Adult Only', facWifi: '📶 Wi-Fi', facParking: '🅿️ Parcare',
      details: 'Vezi oferta →',
    ...
    ru: {
      ...
      facFirstLine: '🏖️ Первая линия', facPool: '🏊 Бассейн', facAqua: '💦 Аквапарк', facBeach: '⛱️ Шезлонги и зонты бесплатно', facAdult: '🔞 Adult Only', facWifi: '📶 Wi-Fi', facParking: '🅿️ Парковка',
  ...
  function scrollToWidgetTop() {
    if (!rootEl) return;
    // Scroll ABOVE the widget to clear sticky site headers (Creatium etc.)
    var rect = rootEl.getBoundingClientRect();
    var scrollTop = (window.pageYOffset || document.documentElement.scrollTop) + rect.top - 120;
